  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved posting as @posting" do
        ...
        post :create, {:posting => { "title" => "invalid value" }}, valid_session
        assigns(:posting).should be_a_new(Posting)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested posting" do
        ...
        Posting.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => posting.to_param, :posting => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the posting as @posting" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Posting.any_instance.stub(:save).and_return(false)
        put :update, {:id => posting.to_param, :posting => { "title" => "invalid value" }}, valid_session
        assigns(:posting).should eq(posting)
      end
